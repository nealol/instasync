...
|---|---|---|
| `restApi` | `"2"` | Any `/api/*` request/response body changes in a breaking way, or a change to the sync transport the plugin requires (e.g. the single-socket `/dmux` multiplexer) |
