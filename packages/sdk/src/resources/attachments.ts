...
export class AttachmentsResource {
	...
	move(path: string, toPath: string, opts: { updateEmbeds?: boolean } = {}): Promise<AttachmentSummary> {
		return this.http.request("POST", `/api/vaults/${this.vaultId}/attachment-moves/${encodePath(path)}`, {
